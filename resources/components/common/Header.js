...
const Header = (props) => <nav className="navbar navbar-default header fixed hidden-print">
    ...
    <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul className="nav navbar-nav navbar-right">
        ...
        <li className="dropdown hidden-xs">
          <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Username <img src="../assets/user-icon.svg" alt="user icon" className="user-icon" /><span className="caret"></span></a>
